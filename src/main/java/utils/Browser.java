...
public class Browser {
    ...
    private static void configureLog4jXML() {
        String content = null;
        File file = new File(Configs.configPath + "/log4j2Tmp.xml"); // for ex foo.txt
        try {
            ...
            File newTextFile = new File(Configs.configPath + "/log4j2.xml");
    ...
    private static void initChrome() {
        ...
        System.setProperty("webdriver.chrome.driver", Configs.configPath + "/chromedriver.exe");
    ...
    private static void initFirefox() {
        ...
        System.setProperty("webdriver.firefox.driver", Configs.configPath + "/geckodriver.exe");
